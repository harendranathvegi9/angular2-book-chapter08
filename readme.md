...
This is the repository of the sample applications from **chapter 08: Dependency Injection and Services** from the book **Angular 2 - A Practical Introduction To The New Web Development Plattform**.
